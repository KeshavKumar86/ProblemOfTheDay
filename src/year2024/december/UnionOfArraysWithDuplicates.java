...
Intuition: Sort both arrays.
Merge the two arrays while counting distinct elements.
...
Add the elements of array a into the set
Add the elements of array b into the set
